...
import uet.oop.bomberman.sound.LoadSound;
...
public class Bomber extends Character {
    ...
    public Bomber(int x, int y, Board board) {
        ...
        placeBombSound = new Audio(new File("res/gamesound/placeBombSound.wav"));
        bomberDieSound = new Audio(new File("res/gamesound/BomBermanDie.wav"));
    }
